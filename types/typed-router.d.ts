...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    '/system/dicts/': RouteRecordInfo<'/system/dicts/', '/system/dicts', Record<never, never>, Record<never, never>>,
    '/system/dicts/[id]': RouteRecordInfo<'/system/dicts/[id]', '/system/dicts/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
